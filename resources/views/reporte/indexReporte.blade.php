...
<div class="container">
    ...
    <div class="bg-white ">
        <div class="m-4 justify-content-lg-around">
            <form class=" m-4 d-flex justify-content-start pt-4 ">
                <input class="form-control col-7 col-sm-6 col-md-8 col-lg-6 mb-1 mr-5" type="search" placeholder="Buscar" aria-label="Search">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td  class="d-flex justify-content-between">
                            ...
                            <form action="{{ url('/reporte_diagnostico/'.$reporte->id) }}" class="d-inline" method="POST">
                                @csrf
                                {{method_field('DELETE')}}
